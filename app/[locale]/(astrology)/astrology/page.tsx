...
import ShopInfoSection from "@components/sections/shop-info";
import ReviewsWidget from "@components/marketing/reviews-widget";
import { setRequestLocale } from 'next-intl/server';

export default function AstrologyPage({ params: { locale } }: { params: { locale: string } }): React.ReactElement {
